"use strict";var f=function(r,a){return function(){try{return a||r((a={exports:{}}).exports,a),a.exports}catch(n){throw (a=0, n)}};};var m=f(function(G,b){
var E=require('@stdlib/math-base-assert-is-nan/dist'),c=require('@stdlib/math-base-special-abs/dist');function O(r,a,n,o,u,x,_){var v,t,s,e,i;if(r<=0)return NaN;for(t=o,s=_,i=0;i<r&&(e=a[t],!(e===e&&u[s]===0));i++)t+=n,s+=x;if(i===r)return NaN;for(v=c(e),i+=1,i;i<r;i++)t+=n,s+=x,!u[s]&&(e=a[t],!E(e)&&(e=c(e),e>v&&(v=e)));return v}b.exports=O
