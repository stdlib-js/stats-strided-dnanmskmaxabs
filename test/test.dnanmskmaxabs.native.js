...
var dnanmskmaxabs = tryRequire( resolve( __dirname, './../lib/dnanmskmaxabs.native.js' ) );
var opts = {
...
tape( 'the function has an arity of 5', opts, function test( t ) {
	t.strictEqual( dnanmskmaxabs.length, 5, 'has expected arity' );
	t.end();
});
...
tape( 'the function calculates the maximum absolute value of a strided array according to a mask, ignoring NaN values', opts, function test( t ) {
	...
	v = dnanmskmaxabs( x.length, x, 1, mask, 1 );
...
tape( 'if provided an `N` parameter less than or equal to `0`, the function returns `NaN`', opts, function test( t ) {
	...
	v = dnanmskmaxabs( 0, x, 1, mask, 1 );
	t.strictEqual( isnan( v ), true, 'returns expected value' );

	v = dnanmskmaxabs( -1, x, 1, mask, 1 );
	t.strictEqual( isnan( v ), true, 'returns expected value' );
...
tape( 'the function supports view offsets', opts, function test( t ) {
	...
	v = dnanmskmaxabs( 6, x1, 2, mask1, 2 );
	t.strictEqual( v, 4.0, 'returns expected value' );
